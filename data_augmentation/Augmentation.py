...
def plot_images(image, rotated, flipped, blured, contrasted, zoomed_image, distorted_image):
...
if __name__ == '__main__':
    ...
    for name, curr_image in save_images.items():
        plt.imsave(f'{args.dst}/{file_name}_{name}.png', curr_image)

    if args.show:
        plot_images(image, rotated, flipped, blured, contrasted, zoomed_image, distorted_image)